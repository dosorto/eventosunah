<div style="font-family: DejaVu Sans, sans-serif; color: #0f172a;">
    <div style="border: 1px solid #dbe3f0; border-radius: 18px; padding: 28px;">
        ...
        <div style="margin-top: 24px; border-top: 1px solid #e2e8f0; padding-top: 20px;">
            <div style="display: table; width: 100%;">
                ...
                <div style="display: table-cell; width: 50%; padding-left: 14px; vertical-align: top;">
                    <div style="font-size: 11px; letter-spacing: 0.24em; text-transform: uppercase; color: #64748b; font-weight: 700;">Evento</div>
                    <div style="margin-top: 10px; font-size: 16px; font-weight: 700;">{{ $document['event_dates'] }}</div>
                    <div style="margin-top: 8px; font-size: 14px; color: #334155;">{{ $document['event_location'] }}</div>
        ...
        <div style="margin-top: 24px; border-radius: 18px; background: #f8fafc; padding: 18px 20px;">
            <div style="font-size: 11px; letter-spacing: 0.24em; text-transform: uppercase; color: #64748b; font-weight: 700;">Pago aplicado</div>
            <div style="margin-top: 12px; display: table; width: 100%;">
                <div style="display: table-cell; vertical-align: middle;">
                    <div style="font-size: 34px; font-weight: 900;">{{ $document['payment_amount_formatted'] ?? number_format($document['payment_amount'], 2) }}</div>
                    <div style="margin-top: 6px; font-size: 14px; color: #475569;">Referencia {{ $document['payment_reference'] }}</div>
                </div>
                <div style="display: table-cell; width: 230px; vertical-align: middle;">
                    <div style="font-size: 12px; color: #64748b;">Registrado por</div>
                    <div style="margin-top: 4px; font-size: 16px; font-weight: 700;">{{ $document['issuer_name'] }}</div>
                </div>
            </div>
        </div>
        ...
        @if(!empty($document['payment_notes']))
            <div style="margin-top: 20px;">
                <div style="font-size: 11px; letter-spacing: 0.24em; text-transform: uppercase; color: #64748b; font-weight: 700;">Observaciones</div>
        ...
        <div style="margin-top: 34px; display: table; width: 100%;">
            <div style="display: table-cell; width: 50%; vertical-align: top; padding-right: 16px;">
                <div style="border-top: 1px solid #94a3b8; padding-top: 10px; font-size: 13px; color: #475569;">
                    {{ $document['receiver_signature_label'] ?? 'Firma de quien recibe' }}
                </div>
            </div>
            <div style="display: table-cell; width: 50%; vertical-align: top; padding-left: 16px;">
                <div style="border-top: 1px solid #94a3b8; padding-top: 10px; font-size: 13px; color: #475569; text-align: right;">
                    Emitido por {{ $document['issuer_name'] }}
                </div>
            </div>
        </div>
    </div>
