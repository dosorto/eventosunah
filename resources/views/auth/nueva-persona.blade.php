                ...
                <div class="formRegister first">
                    <div class="details personal">
                        ...
                        <div class="fields">
                            ...
                            <div class="inputRegister">
                                <label>Nombre</label>
                                <input class="focus:ring-yellow-500 focus:border-yellow-500" type="text" placeholder="Ingrese su nombre" id="nombre" name="nombre" value="{{ $user->name }}" required>
                            ...
                            <div class="inputRegister">
                                ...
                                <input class="focus:ring-yellow-500 focus:border-yellow-500" type="email" placeholder="Ingrese su correo" id="correo" name="correo" value="{{ $user->email }}" required>
                            ...
                            <div class="inputRegister">
                                ...
                                <input class="focus:ring-yellow-500 focus:border-yellow-500" id="direccion" name="direccion" placeholder="Escribe tu dirección..."required></input>
                            ...
                            <div class="inputRegister">
                                ...
                                <select class="focus:ring-yellow-500 focus:border-yellow-500" id="IdTipoPerfil"
                                    ...
                                    <option value="" disabled selected>Seleccione su tipo de perfil</option>
                                    @if(isset($tipoperfiles) && count($tipoperfiles) > 0)
                                        ...
                                        @endforeach
                                    @else
                                        <option value="" disabled>No hay tipos de perfil disponibles</option>
                                    @endif
                                </select>
                            ...
                            <div class="inputRegister estudiante" style="display: none;">
                                ...
                                <input type="text" placeholder="Ingrese su cuenta de estudiante"
                                    id="cuenta_estudiante" name="cuenta_estudiante">
