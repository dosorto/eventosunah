<div>
    @if ($persona && $conferencia)
        <div id="alert-additional-content-3"
            ...
            <div class="flex items-center">
                <svg class="w-12 h-12 text-green-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
    ...
    @else
        <div id="alert-additional-content-2"
            ...
            role="alert">
            <div class="flex items-center">
                <svg class="w-12 h-12 text-red-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
