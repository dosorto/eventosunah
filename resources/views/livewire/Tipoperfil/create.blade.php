                    ...
                    <div class="">
                        <div class="mb-4">
                            <label for="exampleFormControlInput1"
                                class="block text-gray-700 text-sm font-bold mb-2  dark:text-white">Tipo De Perfil:</label>
                            <input type="text"
                                ...
                                id="exampleFormControlInput1" placeholder="Tipoperfil" wire:model="tipoperfil">
                            @error('tipoperfil') <span class="text-red-500">{{ $message }}</span>@enderror
                        </div>
                    </div>
                </div>
