<section class="bg-gray-100 dark:bg-gray-900 flex items-center justify-center">
    <style>
        /* Estilos para el scrollbar en modo claro */
        ::-webkit-scrollbar {
            width: 8px;
        }
    ...
    <div class="grid grid-cols-1 gap-3 md:grid-cols-2 lg:grid-cols-2 w-full max-w-7xl">
        <div
            ...
            <img class="w-48 p-4 h-48 mb-2 rounded-full" src="{{ asset('storage/' . Auth::user()->persona->foto) }}"
                alt="">
        ...
        <div
            ...
            <div class="flex items-center justify-between mb-4">
                <h5 class="text-xl font-bold leading-none text-gray-900 dark:text-white">Proximas conferencias</h5>
                <a href="#" class="text-sm font-medium text-blue-600 hover:underline dark:text-blue-500">
                    Todas
                </a>
            </div>
            <div class="flow-root p-2">
                <ul role="list" class="divide-y divide-gray-200 dark:divide-gray-700 h-48 overflow-y-auto p-4">
