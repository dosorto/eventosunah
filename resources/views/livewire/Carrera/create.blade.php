                    ...
                    <div class="">
                        <div class="mb-4">
                            <label for="exampleFormControlInput1"
                                class="block text-gray-700 text-sm font-bold mb-2  dark:text-white">Carrera:</label>
                            <input type="text"
                                ...
                                id="exampleFormControlInput1" placeholder="Carrera" wire:model="carrera">
                            @error('carrera') <span class="text-red-500">{{ $message }}</span>@enderror
                        </div>
                    <div class="mb-4">
                        <label for="departamentoSelect" class="block text-gray-700 text-sm font-bold mb-2  dark:text-white">Departamento:</label>
                        <select  wire:model="IdDepartamento" id="departamentoSelect" class="shadow bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-yellow-500 focus:border-yellow-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-yellow-500 dark:focus:border-yellow-500" wire:model="departamento">
