            ...
            @foreach ($conferencias as $conferencia)
                <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <div class="p-5">
                        ...
                        <div class="pt-5">
    @php
        $eventoEsPagado = $conferencia->evento->precio > 0;
        $inscripcion = $conferencia->inscripciones->firstWhere('IdPersona', auth()->id());
    @endphp

    @if (!$eventoEsPagado || ($inscripcion && $inscripcion->Status === 'Aceptado'))
