<div class="grid gap-4 p-1" style=" grid-template-columns: repeat(auto-fill, minmax(300px, 1fr));">
...
<div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
        <a href="#">
            <img src="https://th.bing.com/th/id/R.653172c106ff8be48c9881731a77cf82?rik=SPJhwr7DH8CK0A&riu=http%3a%2f%2fwww.puertopixel.com%2fwp-content%2fuploads%2f2011%2f03%2fFondos-web-Texturas-web-abtacto-7.jpg&ehk=jq2ET132JWRHBPfnU8ZZR5pOfWyPfrDZQmlNxKipMqc%3d&risl=&pid=ImgRaw&r=0&sres=1&sresct=1"
                alt="Logo" class="rounded-t-lg" />
        </a>
        <div class="p-5">
            <a href="#">
                <h5 class="mb-2 text-xl font-semibold tracking-tight text-gray-900 dark:text-white">Nombre de la
                    conferencia a mostrar
                </h5>
            </a>
            <table class="w-full text-sm  text-right rtl:text-left text-gray-500 dark:text-gray-400">
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <td class="px-6 py-2">
                        Acxel Fernando Aplicano Aguilar
                    </td>
                </tr>
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                    <td scope="row" class="flex items-center pl-2 py-4 text-gray-900 font-bold dark:text-white">
                                    ...
                                    <div class="px-4 pb-4 md:px-5 md:pb-5">
                                        ...
                                        <div class="relative mb-4">
                                            <input id="course-url" type="text"
                                                ...
                                                value="https://linkDeEjemploParaConferencia" disabled readonly>
                                        ...
                                        <button type="button" data-modal-hide="course-modal"
                                            class="py-2.5 px-5 text-sm font-medium text-gray-900 focus:outline-none bg-yellow-500 rounded-lg hover:bg-yellow-600  focus:z-10 focus:ring-4  dark:bg-yellow-500 dark:text-gray-900 dark:hover:bg-yellow-600">Close</button>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
        <a href="#">
            <img src="http://www.puertopixel.com/wp-content/uploads/2011/03/Fondos-web-Texturas-web-abtacto-2.jpg"
                alt="Logo" class="rounded-t-lg" />
        </a>
        <div class="p-5">
            <a href="#">
