            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg px-4 py-4 dark:bg-gray-800">
                            ...
                            @foreach($localidades as $localidad)
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-600 bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                    ...
                                    <td class="px-6 py-4">
                                        ...
                                        <button wire:click="confirmDelete({{ $localidad->id }})" class="px-3 py-2 text-sm font-medium text-white inline-flex items-center bg-red-500 hover:bg-red-600 focus:ring-4 focus:outline-none focus:ring-red-300 rounded-lg text-center dark:bg-red-500 dark:hover:bg-red-600 dark:focus:ring-red-800">
                                            <svg class="w-6 h-6 text-white dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                ...
                <div x-data="{ open: @entangle('showDeleteModal') }" x-show="open" @keydown.escape.window="open = false" class="fixed inset-0 flex items-center z-50  justify-center p-4 bg-black bg-opacity-50">
                    <div class="bg-white p-6 rounded-lg shadow-lg">
                        ...
                        <p class="mt-2 text-gray-600">¿Estás seguro de que deseas eliminar esta localidad?</p>
