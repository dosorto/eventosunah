                        ...
                        <tbody>
                            @foreach ($conferencias as $conferencia)
                                <tr class="bg-white border-b hover:bg-gray-50 dark:bg-gray-900 dark:hover:bg-gray-600 dark:text-white">
                                    ...
                                    <td class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                        {{ $conferencia->linkreunion }}
                                    </td>
                                    <td class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                        {{ optional($conferencia->conferencista)->id }}
                                    </td>
                                    <td class="px-6 py-4">
                                        ...
                                        <button wire:click="delete({{ $conferencia->id }})"
                                            class="font-medium text-red-600 hover:underline">Borrar</button>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
                ...
                <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:bg-gray-900">
                    <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-800 dark:text-white">
                        <tr>
                            ...
                            <th scope="col" class="px-6 py-3">Link reunión</th>
                    ...
                    <tbody>
                        @foreach ($conferencias as $conferencia)
                            <tr class="bg-white border-b hover:bg-gray-50 dark:bg-gray-900 dark:hover:bg-gray-600 dark:text-white">
                                <td class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">{{ $conferencia->id }}</td>
                                <td class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">{{ $conferencia->nombre }}</td>
                                <td class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">{{ $conferencia->descripcion }}</td>
                                <td class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">{{ $conferencia->fecha }}</td>
                                <td class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">{{ $conferencia->horaInicio }}</td>
                                <td class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">{{ $conferencia->horaFin }}</td>
                                <td class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">{{ $conferencia->lugar }}</td>
                                <td class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">{{ $conferencia->linkreunion }}</td>
                                <td class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">@if ($conferencia->conferencista)
                                ...
                                <td class="px-6 py-4">
                                    <button wire:click="edit({{ $conferencia->id }})" class="font-medium text-blue-600 hover:underline">Editar</button>
                                    <button wire:click="delete({{ $conferencia->id }})" class="font-medium text-red-600 hover:underline">Borrar</button>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
