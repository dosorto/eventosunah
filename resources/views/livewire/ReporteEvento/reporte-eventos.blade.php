        ...
        <section
            ...
            <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 z-10 relative">
                <div class="flex items-center justify-center mb-4">
                    <img class="rounded w-36 h-36 mr-4" src="http://www.puertopixel.com/wp-content/uploads/2011/03/Fondos-web-Texturas-web-abtacto-17.jpg" alt="Extra large avatar">
                    <h1 class="text-4xl font-extrabold tracking-tight leading-none text-gray-900 md:text-5xl lg:text-6xl dark:text-white">
                        Aqui va el nombre del evento
                    </h1>
                </div>
                <p class="mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 lg:px-48 dark:text-gray-200">Este
                    espacio es para poner la descripcion del evento, una pequeña descripcion para saber de que trata el
                    evento.</p>
