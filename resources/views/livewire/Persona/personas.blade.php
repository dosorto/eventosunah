<!-- Persons.blade.php (Vista Livewire) -->
                    ...
                    <tbody>
                        @foreach ($personas as $persona)
                            <tr class="bg-white border-b hover:bg-gray-50 dark:bg-gray-900 dark:hover:bg-gray-600 dark:text-white">
                                ...
                                <td class="px-6 py-4">{{ $persona->user->name }}</td>
                                ...
                                <td class="px-6 py-4">{{ $persona->nacionalidad->nombreNacionalidad }}</td>
                                <td class="px-6 py-4">{{ $persona->tipoperfil->tipoperfil }}</td>
                                

                                <td class="px-6 py-4">
                                    <button wire:click="edit({{ $persona->id }})" class="font-medium text-blue-600 hover:underline">Editar</button>
                                    <button wire:click="delete({{ $persona->id }})" class="font-medium text-red-600 hover:underline">Borrar</button>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
