        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            <div class="p-4 md:p-5">
                <h3 class="mb-1 text-xl font-bold text-gray-900 dark:text-white">
                    Ya estás inscrito a "{{ $tarjetasEvento->nombreevento }}"
                </h3>
                            ...
                            <div class="relative p-4 w-full max-w-md max-h-full">
                                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                    <div class="p-4 md:p-5">
                                        ...
                                        <p class="text-gray-500 dark:text-gray-400 mb-6">Por favor, sube tu comprobante de pago para completar tu inscripción.</p>
                                        <div class="flex items-center mt-6 space-x-4 rtl:space-x-reverse">
                                            ...
                                            <a href="{{ route('recibo', ['evento' => $tarjetasEvento->id]) }}"
                                                ...
                                                class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Subir Comprobante</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
