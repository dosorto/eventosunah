                                    ...
                                    <div class="grid grid-cols-2 gap-6">
                                        ...
                                        <div class="flex flex-col justify-center max-w-sm">
                                            @if ($tarjetasEvento->estado === 'Pagado')
                                                <p data-modal-target="progress-modal" data-modal-toggle="progress-modal"
                                                    class="inscribir-button inline-flex items-center px-3 py-2 text-sm font-semibold text-center text-black bg-yellow-500 rounded-lg hover:bg-yellow-600 focus:ring-4 focus:outline-none focus:ring-yellow-300 dark:bg-yellow-600 dark:hover:bg-yellow-700 dark:focus:ring-yellow-800">
                                                    Inscribirse
    ...
    <div class="relative p-4 w-full max-w-md max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="p-4 md:p-5">
                <h3 class="mb-1 text-xl font-bold text-gray-900 dark:text-white">El evento debe ser pagado</h3>
                <p class="text-gray-500 dark:text-gray-400 mb-6">Por favor, sube el recibo de pago para completar tu
                    inscripción.
                <p>
                    <!-- Modal footer -->
                <div class="flex items-center mt-6 space-x-4 rtl:space-x-reverse">
                    <a href="{{route('recibo', $tarjetasEvento->id)}}" data-modal-hide="progress-modal" type="button"
